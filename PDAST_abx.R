...
#Read in of Microsimulation dataframe, antibiotics dataframe, and cleaning
...
#Find antimicrobial-result matches
...
#Graph of antimicrobial-result matches
...
#Total number of S and R results per panel by AWaRe category
abx_graph <- abx_graph %>% 
...
#Cases where on Watch abx and an Access S alternative / IVOST was provided
...
glue("The personalised approach provided an opportunity to switch from a
     ...
     However, when gentamicin was excluded, the personalised approach provided
     {n_pdast_no_cn} such opportunities compared to {n_standard_no_cn} with the
     standard approach.")

#Access results provided for patients with UTI codes that admission
...
#Number of Access-category oral step-downs facilitated by panels

#PLAN - to determine:
#1. Number/type of results for antimicrobials patient was on
#2. Number of Access switches facilitated by the two approaches
#3. Number of Access oral step-downs, and general number of oral Access options per panel

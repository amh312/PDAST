...
###############################
drops = ["AMP"]
urines5 = pd.read_csv("urines5_amp.csv")
...
###############################
drops = ["SAM"]
urines5 = pd.read_csv("urines5_sam.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['SAM']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["TZP"]
urines5 = pd.read_csv("urines5_tzp.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['TZP']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["CZO"]
urines5 = pd.read_csv("urines5_czo.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['CZO']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["CRO"]
urines5 = pd.read_csv("urines5_cro.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['CRO']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["CAZ"]
urines5 = pd.read_csv("urines5_caz.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['CAZ']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["FEP"]
urines5 = pd.read_csv("urines5_fep.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['FEP']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["MEM"]
urines5 = pd.read_csv("urines5_mem.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['MEM']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["CIP"]
urines5 = pd.read_csv("urines5_cip.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['CIP']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["GEN"]
urines5 = pd.read_csv("urines5_gen.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['GEN']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["SXT"]
urines5 = pd.read_csv("urines5_sxt.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['SXT']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))
...
###############################
drops = ["NIT"]
urines5 = pd.read_csv("urines5_nit.csv")
urines5['standard_age'] = urines5['standard_age'].map(str)
y = urines5['NIT']
urines5 = pd.get_dummies(urines5.drop(drops, axis=1))

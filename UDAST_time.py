...
rocs_5t_1_1['df1'] = 1
rocs_5t_1_1['df2'] = 1
rocs_5t_1_1 = pd.DataFrame(rocs_5t_1_1,index=[1])
own_time_per("urines_5t_2.csv")
rocs_5t_2_2 = rocs
rocs_5t_2_2['df1'] = 2
rocs_5t_2_2['df2'] = 2
rocs_5t_2_2 = pd.DataFrame(rocs_5t_2_2,index=[1])
own_time_per("urines_5t_3.csv")
rocs_5t_3_3 = rocs
rocs_5t_3_3['df1'] = 3
rocs_5t_3_3['df2'] = 3
rocs_5t_3_3 = pd.DataFrame(rocs_5t_3_3,index=[1])
own_time_per("urines_5t_4.csv")
rocs_5t_4_4 = rocs
rocs_5t_4_4['df1'] = 4
rocs_5t_4_4['df2'] = 4
rocs_5t_4_4 = pd.DataFrame(rocs_5t_4_4,index=[1])
...
rocs_5t_1_2['df1'] = 1
rocs_5t_1_2['df2'] = 2
rocs_5t_1_2 = pd.DataFrame(rocs_5t_1_2,index=[1])

across_time_per("urines_5t_1.csv","urines_5t_3.csv")
rocs_5t_1_3 = rocs
rocs_5t_1_3['df1'] = 1
rocs_5t_1_3['df2'] = 3
rocs_5t_1_3 = pd.DataFrame(rocs_5t_1_3,index=[1])

across_time_per("urines_5t_1.csv","urines_5t_4.csv")
rocs_5t_1_4 = rocs
rocs_5t_1_4['df1'] = 1
rocs_5t_1_4['df2'] = 4
rocs_5t_1_4 = pd.DataFrame(rocs_5t_1_4,index=[1])

across_time_per("urines_5t_2.csv","urines_5t_1.csv")
rocs_5t_2_1 = rocs
rocs_5t_2_1['df1'] = 2
rocs_5t_2_1['df2'] = 1
rocs_5t_2_1 = pd.DataFrame(rocs_5t_2_1,index=[1])

across_time_per("urines_5t_2.csv","urines_5t_3.csv")
rocs_5t_2_3 = rocs
rocs_5t_2_3['df1'] = 2
rocs_5t_2_3['df2'] = 3
rocs_5t_2_3 = pd.DataFrame(rocs_5t_2_3,index=[1])

across_time_per("urines_5t_2.csv","urines_5t_4.csv")
rocs_5t_2_4 = rocs
rocs_5t_2_4['df1'] = 2
rocs_5t_2_4['df2'] = 4
rocs_5t_2_4 = pd.DataFrame(rocs_5t_2_4,index=[1])

across_time_per("urines_5t_3.csv","urines_5t_1.csv")
rocs_5t_3_1 = rocs
rocs_5t_3_1['df1'] = 3
rocs_5t_3_1['df2'] = 1
rocs_5t_3_1 = pd.DataFrame(rocs_5t_3_1,index=[1])

across_time_per("urines_5t_3.csv","urines_5t_2.csv")
rocs_5t_3_2 = rocs
rocs_5t_3_2['df1'] = 3
rocs_5t_3_2['df2'] = 2
rocs_5t_3_2 = pd.DataFrame(rocs_5t_3_2,index=[1])

across_time_per("urines_5t_3.csv","urines_5t_4.csv")
rocs_5t_3_4 = rocs
rocs_5t_3_4['df1'] = 3
rocs_5t_3_4['df2'] = 4
rocs_5t_3_4 = pd.DataFrame(rocs_5t_3_4,index=[1])

across_time_per("urines_5t_4.csv","urines_5t_1.csv")
rocs_5t_4_1 = rocs
rocs_5t_4_1['df1'] = 4
rocs_5t_4_1['df2'] = 1
rocs_5t_4_1 = pd.DataFrame(rocs_5t_4_1,index=[1])

across_time_per("urines_5t_4.csv","urines_5t_2.csv")
rocs_5t_4_2 = rocs
rocs_5t_4_2['df1'] = 4
rocs_5t_4_2['df2'] = 2
rocs_5t_4_2 = pd.DataFrame(rocs_5t_4_2,index=[1])

across_time_per("urines_5t_4.csv","urines_5t_3.csv")
rocs_5t_4_3 = rocs
rocs_5t_4_3['df1'] = 4
rocs_5t_4_3['df2'] = 3
rocs_5t_4_3 = pd.DataFrame(rocs_5t_4_3,index=[1])

rocs_5t = pd.concat([rocs_5t_1_1, rocs_5t_1_2,
                     rocs_5t_1_3,rocs_5t_1_4,
                     rocs_5t_2_1,rocs_5t_2_2,
                     rocs_5t_2_3,rocs_5t_2_4,
                     rocs_5t_3_1,rocs_5t_3_2,
                     rocs_5t_3_3,rocs_5t_3_4,
                     rocs_5t_4_1,rocs_5t_4_2,
                     rocs_5t_4_3,rocs_5t_4_4],ignore_index=True)